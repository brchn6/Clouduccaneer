...
from cb.spotwrap import (
    run, print_lines, fetch, fetch_many, get_metadata,
    search_spotify, validate_spotify_url, normalize_spotify_url,
    get_playlist_tracks
)
...
class TestFetch:
    ...
    def test_fetch_with_lyrics(self, mock_run):
        ...
        result = fetch("https://open.spotify.com/track/test", "/tmp/downloads", lyrics=True)
    ...
    def test_fetch_with_playlist_numbering(self, mock_run):
        ...
        result = fetch("https://open.spotify.com/playlist/test", "/tmp/downloads", playlist_numbering=True)
...
class TestGetMetadata:
    ...
    def test_get_metadata_success(self, mock_run):
        ...
        mock_result.stdout = "Artist: Test Artist\nTitle: Test Title\nAlbum: Test Album\n"
